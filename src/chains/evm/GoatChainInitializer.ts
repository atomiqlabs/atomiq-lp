...
import {
    EVMFees,
    initializeGoat, GoatChainType, JsonRpcProviderWithRetries, WebSocketProviderWithRetries
...
export const GoatChainInitializer: ChainInitializer<GoatChainType, any, typeof template> = {
    loadChain: (configuration, bitcoinRpc, bitcoinNetwork) => {
        ...
        const signer = new EVMPersistentSigner(evmSigner, evmSigner.address, chainInterface, directory+"/GOAT", 0n, 200_000n, 15*1000);
