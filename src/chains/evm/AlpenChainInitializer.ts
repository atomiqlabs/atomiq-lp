...
import {
    AlpenChainType,
    EVMFees,
    EVMSigner, initializeAlpen,
    JsonRpcProviderWithRetries, WebSocketProviderWithRetries
...
export const AlpenChainInitializer: ChainInitializer<AlpenChainType, any, typeof template> = {
    loadChain: (configuration, bitcoinRpc, bitcoinNetwork) => {
        ...
        const signer = new EVMPersistentSigner(evmSigner, evmSigner.address, chainInterface, directory+"/ALPEN", 0n, 200_000n, 15*1000);
